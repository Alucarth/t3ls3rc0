...
<body>
  <?php
 if($v5!=null){?>
    <form class="form-horizontal col-lg-12 col-md-12 col-xs-12" method="post" enctype="multipart/form-data" id="form_registro_material" name="form_registro_material"  action="RegistrarDatosNuevaEntrega">
    <div class="col-xs-12"> 
      <div class="form-group">
        <div class="col-xs-8">   
          <label>TÉCNICO A ASIGNAR MATERIAL</label>
          <input class="form-control" list="colores" placeholder="Elige personal" name="tecnico" style="text-transform:uppercase" required>
          <datalist id="colores">
            <?php foreach ($v5 as $row1) { ?>
              <option id="tecnico" name="tecnico" value="<?php echo $row1->Id_asignacion."-".$row1->Nombre_personal." ".$row1->Ap_paterno_personal." ".$row1->Ap_materno_personal;?>"></option>
      ...
      $modem1=5;      $modem2=0;
      //cable c/portante
      $rg6c=305;      $rg6c1=$rg6c/305;      $rg6c2=0;      $rg6c3=$rg6c2/305;
      //cable s/portante
      $rg6s=305;      $rg6s1=$rg6s/305;      $rg6s2=0;      $rg6s3=$rg6s2/305;
