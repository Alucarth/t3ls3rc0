				...
				<tbody>
		         ...
		         <?php foreach ($v5 as $row) { ?>
		            <tr>
						...
						<td><button type="button" class="btn btn-dark" onclick='borrar(<?php echo $row->idPersonal;?>)' disabled ><span class="glyphicon glyphicon-file"></span> AÑADIR</button></td>
						<td><button type="button" class="btn btn-dark" onclick='ver_material_tec(<?php echo $row->Id_personal;?>)' disabled ><span class="glyphicon glyphicon-file"></span> VER DATOS</button></td>
	...
	<div class="modal fade form_new" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
	    <div class="modal-dialog modal-lg" role="document">
	      <div class="modal-content">
	          ...
	          <h4 class="modal-title" id="myLargeModalLabel"><strong>FORMULARIO DE REGISTRO DE ASIGNACIÓN DE MATERIAL SUBDEALERS</strong></h4> </div>
