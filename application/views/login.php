        ...
        <div id="wrapper">
            <div id="login" class="animate form">
                <section class="login_content">
                    <form action="<?=base_url()?>index.php/login_controller/login" method="post">
                        ...
                        <div class="separator">
                            <div>
                                <h1><!--i class="fa fa-paw" style="font-size: 26px;"></i--> Empresa de Telecomunicaciones, Servicios y Comercio</h1>

                                <p>©2018 All Rights Reserved. M@bn@r</p>
                            </div>
                        </div>
                    </form>
                    <!-- form -->
