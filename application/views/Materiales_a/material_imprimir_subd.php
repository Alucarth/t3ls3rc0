...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var rows = [
		    ...
		    [9,cp0,cp1,cp2,"   "+cp3,9,cp0,cp1,cp2,"   "+cp3],
		    [10,sp0,sp1,sp2,"   "+sp3,10,sp0,sp1,sp2,"   "+sp3],

		    [11,deco0,deco1,deco2,"   "+deco3,11,deco0,deco1,deco2,"   "+deco3],
		    [12,modem0,modem1,modem2,"   "+modem3,12,modem0,modem1,modem2,"   "+modem3]
		];
		...
		pdf.text(30,20,"		*****INVENTARIO******                         FECHA:"+fecha);
		pdf.setFontSize(8.7);
		pdf.text(30,30,"SUBDEALER:"+nom+"          CÓDIGO:"+cod);
		pdf.setFontSize(10);
		pdf.text(395,10,"TELSERCO S.R.L. 2018 ");
    	pdf.text(395,20,"		*****INVENTARIO******                         FECHA:"+fecha);
    	pdf.setFontSize(8.7);
    	pdf.text(395,30,"SUBDEALER:"+nom+"          CÓDIGO:"+cod);
		...
		pdf.text(30,580,"------------------------------- 		                    ------------------------------");
		pdf.text(30,590,"   FIRMA INSPECCIÓN 					FIRMA SUBDEALER");
		pdf.text(400,580," ---------------------------------                           ------------------------------");
    	pdf.text(400,590,"   FIRMA INSPECCIÓN 				 FIRMA SUBDEALER");
